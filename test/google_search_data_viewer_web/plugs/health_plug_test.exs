defmodule GoogleSearchDataViewerWeb.HealthPlugTest do
  use GoogleSearchDataViewerWeb.ConnCase, async: true

  import ExUnit.CaptureLog

  alias GoogleSearchDataViewerWeb.HealthPlug
  ...
  describe "call/2" do
    ...
    test "given the database is not ready, returns 500 internal server error " do
      expect(Ecto.Adapters.SQL, :query, fn GoogleSearchDataViewer.Repo, "SELECT 1" ->
