...
config :google_search_data_viewer,
  ecto_repos: [GoogleSearchDataViewer.Repo]
...
config :google_search_data_viewer, GoogleSearchDataViewer.Mailer, adapter: Swoosh.Adapters.Local
